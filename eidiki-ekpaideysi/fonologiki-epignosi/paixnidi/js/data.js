...
Phono.data = {
    ...
    teacherNotes: {
        ...
        phonemeSynthesis: "Οι ήχοι της λέξης ΑΚΟΥΓΟΝΤΑΙ ένας-έναν με παύση ανάμεσά τους (π.χ. «γ… ά… τ… α»), ενώ εμφανίζονται και οπτικά σε φυσαλίδες. Το παιδί τους ενώνει νοερά και διαλέγει την εικόνα. Ξεκινά από λέξεις 4 ήχων και προχωρά σε 5 και 6.",
