...
Phono.data = {
    ...
    teacherNotes: {
        ...
        // Level 2 — Συλλαβές
        syllableSynthesis: "Χωρίς ήχο από την εφαρμογή: πες ο ίδιος/η ίδια τις συλλαβές μιας λέξης, μία-μία με παύση ανάμεσά τους (π.χ. «τούρ … τα»), και το παιδί διαλέγει ποια εικόνα/λέξη ταιριάζει — το γραπτό δεν εμφανίζεται πουθενά από μόνο του. Πάτησε «🔒 Λέξη (δάσκαλος)» για να δεις τη λέξη και τις συλλαβές της πριν την πεις. Ο διακόπτης 👁️/🙈 δείχνει το γραπτό μέσα στο μήνυμα επιβράβευσης, μόνο αφού απαντήσει το παιδί.",
        syllableCounting: "Το παιδί χτυπά για κάθε συλλαβή μιας λέξης. Το κουμπί δίπλα εναλλάσσει Εύκολο/Δύσκολο: στο Δύσκολο οι τελείες μέτρησης κρύβονται αμέσως μόλις χτυπήσει, οπότε το παιδί πρέπει να θυμάται πόσες φορές χτύπησε αντί να τις μετράει βλέποντάς τες.",
