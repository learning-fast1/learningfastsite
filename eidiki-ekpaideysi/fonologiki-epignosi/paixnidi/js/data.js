...
Phono.data = {
    ...
    teacherNotes: {
        ...
        // Level 2 — Συλλαβές
        syllableSynthesis: "Το παιδί ΑΚΟΥΕΙ τις συλλαβές μιας λέξης, μία-μία με παύση ανάμεσά τους (π.χ. «τούρ … τα»), και διαλέγει ποια εικόνα/λέξη ταιριάζει — το γραπτό δεν εμφανίζεται πουθενά από μόνο του. Πάτησε «🔒 Λέξη (δάσκαλος)» αν χρειάζεσαι να τη δεις εσύ, ή «🗣️ Το είπε ο θεραπευτής» αν προτιμάς να πεις εσύ τις συλλαβές αντί για τη συνθετική φωνή. Ο διακόπτης 👁️/🙈 δείχνει το γραπτό μέσα στο μήνυμα επιβράβευσης, μόνο αφού απαντήσει το παιδί.",
        syllableCounting: "Το παιδί χτυπά για κάθε συλλαβή μιας λέξης. Η δική σου προφορά μπορεί να τονίζει πιο καθαρά τα όρια κάθε συλλαβής απ' ό,τι η συνθετική φωνή — χρησιμοποίησε το «🗣️ Το είπε ο θεραπευτής» όποτε το κάνεις. Το κουμπί δίπλα εναλλάσσει Εύκολο/Δύσκολο: στο Δύσκολο οι τελείες μέτρησης κρύβονται αμέσως μόλις χτυπήσει, οπότε το παιδί πρέπει να θυμάται πόσες φορές χτύπησε αντί να τις μετράει βλέποντάς τες.",
        ...
        syllableRemoval: "Το παιδί ακούει μια λέξη και λέει τι μένει αν αφαιρεθεί μια συλλαβή. Η σειρά δυσκολίας είναι: πρώτα αφαιρείται η ΤΕΛΕΥΤΑΙΑ συλλαβή (πιο εύκολο — ό,τι μένει είναι ήδη ένα γνώριμο κομμάτι), μετά η ΠΡΩΤΗ, και τελευταία η ΜΕΣΑΙΑ (πιο δύσκολο — τα δύο κομμάτια που μένουν πρέπει να «κολλήσουν» νοητά). Ωφελείται πολύ από ζωντανή, αργή προφορά — χρησιμοποίησε το «🗣️ Το είπε ο θεραπευτής» όποτε διαβάζεις εσύ. Το κουμπί «🔒 Απάντηση (δάσκαλος)» δείχνει τη λέξη, τη συλλαβή που αφαιρείται και τη σωστή απάντηση.",
