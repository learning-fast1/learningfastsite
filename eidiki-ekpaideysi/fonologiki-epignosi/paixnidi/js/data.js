...
Phono.data = {
    ...
    teacherNotes: {
        ...
        // Level 2 — Συλλαβές
        syllableSynthesis: "Χωρίς ήχο από την εφαρμογή: πες ο ίδιος/η ίδια τις συλλαβές μιας λέξης, μία-μία με παύση ανάμεσά τους (π.χ. «τούρ … τα»), και το παιδί διαλέγει ποια εικόνα/λέξη ταιριάζει. Πάτησε «🔒 Λέξεις (δάσκαλος)» ΠΡΙΝ ξεκινήσετε για να δεις όλες τις λέξεις της συνεδρίας μαζί με τις συλλαβές τους, και σημείωσέ τις ή βγάλε τους φωτογραφία, ώστε να τις έχεις πρόχειρες καθώς παίζετε. Μόλις το παιδί βρει τη σωστή εικόνα, η λέξη εμφανίζεται συλλαβιστά στην οθόνη ως επιβεβαίωση.",
        ...
        findFinalPhoneme: "Τελευταία δραστηριότητα του επιπέδου, αφού ο τελικός ήχος είναι πιο δύσκολος από τον αρχικό. Ίδια λογική: το παιδί ακούει τη λέξη και πατάει το κουμπί με τον σωστό ΗΧΟ. Το κουμπί «🔒 Λέξεις (δάσκαλος)» δείχνει όλες τις λέξεις της συνεδρίας. Ξεκινά από τελικά φωνήεντα (πιο εύκολα), μετά το -ς. Εξήγησε στο παιδί ότι ο τελευταίος ήχος μπορεί να είναι και φωνήεν.",
        soundOddOneOut: "Τρεις λέξεις μοιράζονται τον ίδιο αρχικό ήχο, μία διαφέρει, και το παιδί βρίσκει ποια. Η θέση της «διαφορετικής» αλλάζει κάθε γύρο, δεν είναι πάντα στην ίδια θέση. Πες εσύ και τις τέσσερις λέξεις δυνατά, με μικρή παύση, ώστε το παιδί να ακούσει καθαρά ποια ξεχωρίζει.",
        ...
        elkoninBoxes: "Το παιδί τοποθετεί κάθε ήχο μιας λέξης στο δικό του κουτάκι (κουτάκια Elkonin). Ανάμεσα στα πλακίδια-ήχους υπάρχουν πάντα 1-2 «παγίδες», δηλαδή ήχοι που δεν ανήκουν καθόλου στη λέξη· αν το παιδί σύρει μία, απλά δεν κουμπώνει σε κανένα κουτάκι. Δεν υπάρχει εκφώνηση φωνής σε αυτό το στάδιο. Πες εσύ τη λέξη φωνηματικά, αργά, πριν ξεκινήσει η άσκηση.",
        phonemeDeletion: "Το παιδί ακούει μόνο την αρχική λέξη. Ποιος ήχος αφαιρείται φαίνεται γραπτά στην οδηγία, όχι στην εκφώνηση, και η σωστή απάντηση δεν ακούγεται ποτέ αυτόματα. Αν σιγάσεις τη φωνή από το εικονίδιο 🔊, πες εσύ μόνο την αρχική λέξη και τόνισε καθαρά τον ήχο που αφαιρείται. Το παιδί πρέπει να πει μόνο του τι απομένει. Το κουμπί δίπλα εναλλάσσει αν αφαιρείται ο ΠΡΩΤΟΣ ή ο ΤΕΛΕΥΤΑΙΟΣ ήχος (ξεκίνα από τον τελευταίο, που είναι πιο εύκολος). Το κουμπί «🔒 Λέξεις (δάσκαλος)» δείχνει όλες τις λέξεις της συνεδρίας, τον ήχο που αφαιρείται σε κάθε μία και τη σωστή απάντηση.",
    },
