...
Phono.data = {
    ...
    rhymePairs: [
        ...
        { word1: "φίδι", word2: "κλειδί", emoji1: "🐍", emoji2: "🔑", ending: "-δί" },
        { word1: "μέλι", word2: "κουνέλι", emoji1: "🍯", emoji2: "🐰", ending: "-έλι" },
        { word1: "σπίτι", word2: "κουτί", emoji1: "🏠", emoji2: "📦", ending: "-τί" },
    ...
    /* ----------------------------------------------------------
       SYLLABLE REMOVAL DATA for Level 2
       ---------------------------------------------------------- */
    syllableRemoval: [
        { word: "μπανάνα", syllables: ["μπα", "νά", "να"], remove: "μπα", removeIndex: 0, remaining: "νάνα", emoji: "🍌" },
        { word: "μπανάνα", syllables: ["μπα", "νά", "να"], remove: "να", removeIndex: 2, remaining: "μπανά", emoji: "🍌" },
        { word: "πεπόνι", syllables: ["πε", "πό", "νι"], remove: "πε", removeIndex: 0, remaining: "πόνι", emoji: "🍈" },
        { word: "πεπόνι", syllables: ["πε", "πό", "νι"], remove: "νι", removeIndex: 2, remaining: "πεπό", emoji: "🍈" },
        { word: "κουνέλι", syllables: ["κου", "νέ", "λι"], remove: "κου", removeIndex: 0, remaining: "νέλι", emoji: "🐰" },
        { word: "κουνέλι", syllables: ["κου", "νέ", "λι"], remove: "λι", removeIndex: 2, remaining: "κουνέ", emoji: "🐰" },
        { word: "πορτοκάλι", syllables: ["πορ", "το", "κά", "λι"], remove: "πορ", removeIndex: 0, remaining: "τοκάλι", emoji: "🍊" },
        { word: "καρπούζι", syllables: ["καρ", "πού", "ζι"], remove: "καρ", removeIndex: 0, remaining: "πούζι", emoji: "🍉" },
        { word: "καρπούζι", syllables: ["καρ", "πού", "ζι"], remove: "ζι", removeIndex: 2, remaining: "καρπού", emoji: "🍉" },
        { word: "αλεπού", syllables: ["α", "λε", "πού"], remove: "α", removeIndex: 0, remaining: "λεπού", emoji: "🦊" },
        { word: "μπαλόνι", syllables: ["μπα", "λό", "νι"], remove: "μπα", removeIndex: 0, remaining: "λόνι", emoji: "🎈" },
        { word: "σοκολάτα", syllables: ["σο", "κο", "λά", "τα"], remove: "σο", removeIndex: 0, remaining: "κολάτα", emoji: "🍫" },
        { word: "σοκολάτα", syllables: ["σο", "κο", "λά", "τα"], remove: "τα", removeIndex: 3, remaining: "σοκολά", emoji: "🍫" },
        { word: "λεμόνι", syllables: ["λε", "μό", "νι"], remove: "λε", removeIndex: 0, remaining: "μόνι", emoji: "🍋" },
        { word: "ελέφαντας", syllables: ["ε", "λέ", "φα", "ντας"], remove: "ε", removeIndex: 0, remaining: "λέφαντας", emoji: "🐘" },
        { word: "χελώνα", syllables: ["χε", "λώ", "να"], remove: "χε", removeIndex: 0, remaining: "λώνα", emoji: "🐢" },
        { word: "χελώνα", syllables: ["χε", "λώ", "να"], remove: "να", removeIndex: 2, remaining: "χελώ", emoji: "🐢" },
        { word: "δελφίνι", syllables: ["δελ", "φί", "νι"], remove: "δελ", removeIndex: 0, remaining: "φίνι", emoji: "🐬" },
        { word: "δελφίνι", syllables: ["δελ", "φί", "νι"], remove: "νι", removeIndex: 2, remaining: "δελφί", emoji: "🐬" },
        { word: "γουρούνι", syllables: ["γου", "ρού", "νι"], remove: "γου", removeIndex: 0, remaining: "ρούνι", emoji: "🐷" },
        { word: "κουδούνι", syllables: ["κου", "δού", "νι"], remove: "κου", removeIndex: 0, remaining: "δούνι", emoji: "🔔" },
        { word: "παγωτό", syllables: ["πα", "γω", "τό"], remove: "πα", removeIndex: 0, remaining: "γωτό", emoji: "🍦" },
        { word: "ποδήλατο", syllables: ["πο", "δή", "λα", "το"], remove: "πο", removeIndex: 0, remaining: "δήλατο", emoji: "🚲" },
        { word: "βερίκοκο", syllables: ["βε", "ρί", "κο", "κο"], remove: "βε", removeIndex: 0, remaining: "ρίκοκο", emoji: "🍑" },
        { word: "κοτόπουλο", syllables: ["κο", "τό", "που", "λο"], remove: "κο", removeIndex: 0, remaining: "τόπουλο", emoji: "🍗" },
        { word: "κρεβάτι", syllables: ["κρε", "βά", "τι"], remove: "κρε", removeIndex: 0, remaining: "βάτι", emoji: "🛏️" },
        { word: "ποτάμι", syllables: ["πο", "τά", "μι"], remove: "μι", removeIndex: 2, remaining: "ποτά", emoji: "🏞️" },
        { word: "καραμέλα", syllables: ["κα", "ρα", "μέ", "λα"], remove: "κα", removeIndex: 0, remaining: "ραμέλα", emoji: "🍬" },
        { word: "γέφυρα", syllables: ["γέ", "φυ", "ρα"], remove: "ρα", removeIndex: 2, remaining: "γέφυ", emoji: "🌉" },
    ],
    ...
    teacherNotes: {
        ...
        wordPosition: "Το παιδί ακούει μια πρόταση και μετά βρίσκει ποια λέξη ήταν πρώτη, τελευταία ή μεσαία. Σίγασε τη φωνή από το εικονίδιο 🔊 αν θέλεις να διαβάζεις εσύ και να επαναλαμβάνεις την πρόταση με τον δικό σου ρυθμό — το κουμπί «🔒 Απάντηση (δάσκαλος)» δείχνει την πρόταση και τη σωστή απάντηση. Το στάδιο της μεσαίας λέξης είναι το πιο απαιτητικό. Φρόντισε να έχει εμπεδωθεί πρώτα η πρώτη/τελευταία θέση.",
        ...
        wordDeletion: "Το παιδί ακούει μια πρόταση και μετά την ξαναλέει χωρίς μία συγκεκριμένη λέξη. Σίγασε τη φωνή από το εικονίδιο 🔊 αν θέλεις να διαβάσεις εσύ την αρχική πρόταση, και χρησιμοποίησε το κουμπί «Επανάληψη» όσες φορές χρειαστεί πριν αποφασίσει το παιδί. Το κουμπί «🔒 Απάντηση (δάσκαλος)» δείχνει την πρόταση, τη λέξη που αφαιρείται και τη σωστή απάντηση, χωρίς να χρειάζεται να τα μαντέψεις από τις επιλογές.",

        // Level 2 — Συλλαβές
        syllableSynthesis: "Οι συλλαβές μιας λέξης εμφανίζονται οπτικά, μία-μία, και το παιδί μαντεύει τη λέξη. Δεν υπάρχει εκφώνηση φωνής σε αυτό το στάδιο. Πες εσύ κάθε συλλαβή δυνατά καθώς εμφανίζεται, με μικρή παύση ανάμεσά τους ανάλογα με το επίπεδο του παιδιού.",
        syllableCounting: "Το παιδί χτυπά για κάθε συλλαβή μιας λέξης. Η δική σου προφορά μπορεί να τονίζει πιο καθαρά τα όρια κάθε συλλαβής απ' ό,τι η συνθετική φωνή. Σίγασε τη φωνή από το εικονίδιο 🔊 και πες τη λέξη συλλαβιστά, αργά.",
        syllableSplit: "Το παιδί σέρνει τις συλλαβές μιας λέξης στη σωστή σειρά. Η ολόκληρη λέξη δεν εμφανίζεται πουθενά στην οθόνη (μόνο η εικόνα και οι μπερδεμένες συλλαβές) ώστε το παιδί να μην τη διαβάζει έτοιμη αντί να τη συνθέσει μόνο του. Πάτησε το κουμπί «🔒 Λέξεις (δάσκαλος)» για να δεις όλες τις λέξεις της συνεδρίας μόνο εσύ, αν χρειάζεσαι βοήθεια. Σίγασε τη φωνή από το εικονίδιο 🔊 αν προτιμάς να διαβάζεις εσύ τη λέξη κάθε φορά.",
        syllableRemoval: "Το παιδί ακούει μια λέξη και λέει τι μένει αν αφαιρεθεί μια συλλαβή. Ωφελείται πολύ από ζωντανή, αργή προφορά. Σίγασε τη φωνή από το εικονίδιο 🔊 και τόνισε εσύ προφορικά τη συλλαβή που αφαιρείται. Το κουμπί «🔒 Απάντηση (δάσκαλος)» δείχνει τη λέξη, τη συλλαβή που αφαιρείται και τη σωστή απάντηση, χωρίς να χρειάζεται να τα μαντέψεις από τις επιλογές.",

        // Level 3 — Ομοιοκαταληξία
        findRhyme: "Το παιδί ακούει μια λέξη και διαλέγει ποια άλλη ομοιοκαταληκτεί μαζί της. Η δική σου φωνή μπορεί να τονίζει καλύτερα την κατάληξη. Σίγασε τη φωνή από το εικονίδιο 🔊 αν θέλεις να το κάνεις εσύ.",
        ...
        phonemeDeletion: "Το παιδί ακούει μια λέξη και λέει τι μένει αν αφαιρεθεί ο πρώτος ήχος. Σίγασε τη φωνή από το εικονίδιο 🔊 αν θέλεις να προφέρεις εσύ τη λέξη και να τονίσεις καθαρά τον ήχο που αφαιρείται. Το κουμπί «🔒 Απάντηση (δάσκαλος)» δείχνει τη λέξη, τον ήχο που αφαιρείται και τη σωστή απάντηση, χωρίς να χρειάζεται να τα μαντέψεις από τις επιλογές.",
    },
