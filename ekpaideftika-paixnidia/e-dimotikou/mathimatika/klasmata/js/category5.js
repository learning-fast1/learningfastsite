const Category5 = {
    ...
    templates1: [
        ...
        (n,t,a,b,r) => `Σε ένα συλλογή υπάρχουν ${t} γραμματόσημα. Τα <b>${a}/${b}</b> είναι ξένα. Πόσα γραμματόσημα είναι ξένα;`,
        (n,t,a,b,r) => `${n} έχει ${t} αυτοκόλλητα χαρτάκια. Τα <b>${a}/${b}</b> είναι με ζώα. Πόσα χαρτάκια έχουν ζώα;`,
        (n,t,a,b,r) => `Σε ένα κουτί υπάρχουν ${t} κηρομπογιές. Τα <b>${a}/${b}</b> είναι ζεστά χρώματα. Πόσες κηρομπογιές είναι ζεστά χρώματα;`,
        (n,t,a,b,r) => `${n} έχει ${t} λεπτά τσέπης. Ξόδεψε τα <b>${a}/${b}</b> για ζάρια. Πόσα λεπτά ξόδεψε;`,
        (n,t,a,b,r) => `Σε ένα σακουλάκι υπάρχουν ${t} καρύδια. Τα <b>${a}/${b}</b> είναι ώριμα. Πόσα καρύδια είναι ώριμα;`,
        (n,t,a,b,r) => `${n} μάζεψε ${t} βελανίδια. Τα <b>${a}/${b}</b> τα έδωσε στα σκιουράκια. Πόσα βελανίδια έδωσε;`,
        (n,t,a,b,r) => `Σε ένα μαγαζί υπάρχουν ${t} ζευγάρια παπούτσια. Τα <b>${a}/${b}</b> είναι αθλητικά. Πόσα ζευγάρια είναι αθλητικά;`,
        (n,t,a,b,r) => `${n} έχει ${t} ώρες διακοπών. Τις <b>${a}/${b}</b> τις πέρασε στην παραλία. Πόσες ώρες πέρασε στην παραλία;`,
        (n,t,a,b,r) => `Σε ένα ζωολογικό κήπο υπάρχουν ${t} ζώα. Τα <b>${a}/${b}</b> είναι θηλαστικά. Πόσα ζώα είναι θηλαστικά;`,
        (n,t,a,b,r) => `Σε ένα φούρνο φτιάχτηκαν ${t} αρτοσκευάσματα. Τα <b>${a}/${b}</b> είναι γλυκά. Πόσα αρτοσκευάσματα είναι γλυκά;`,
        (n,t,a,b,r) => `${n} έχει ${t} βήματα μέχρι το σχολείο. Τα <b>${a}/${b}</b> τα διανύει τρέχοντας. Πόσα βήματα τρέχει;`,
        (n,t,a,b,r) => `Σε ένα πλοίο υπάρχουν ${t} επιβάτες. Τα <b>${a}/${b}</b> είναι παιδιά. Πόσοι επιβάτες είναι παιδιά;`,
        (n,t,a,b,r) => `${n} έχει ${t} λουλούδια στον κήπο. Τα <b>${a}/${b}</b> είναι τριαντάφυλλα. Πόσα λουλούδια είναι τριαντάφυλλα;`,
        (n,t,a,b,r) => `Σε ένα πάρτι γενεθλίων υπάρχουν ${t} μπαλόνια. Τα <b>${a}/${b}</b> είναι μπλε. Πόσα μπαλόνια είναι μπλε;`,
        (n,t,a,b,r) => `${n} έχει ${t} χαρτοπαίγνια. Τα <b>${a}/${b}</b> είναι κόκκινα. Πόσα χαρτοπαίγνια είναι κόκκινα;`,
        (n,t,a,b,r) => `Σε ένα σχολείο υπάρχουν ${t} υπολογιστές. Τα <b>${a}/${b}</b> είναι φορητοί. Πόσοι υπολογιστές είναι φορητοί;`,
        (n,t,a,b,r) => `${n} έχει ${t} σελίδες να διαβάσει. Τις <b>${a}/${b}</b> τις διάβασε σήμερα. Πόσες σελίδες διάβασε σήμερα;`,
        (n,t,a,b,r) => `Σε ένα χωριό υπάρχουν ${t} σπίτια. Τα <b>${a}/${b}</b> έχουν κήπο. Πόσα σπίτια έχουν κήπο;`,
        (n,t,a,b,r) => `${n} έχει ${t} αθλητικές στολές. Τις <b>${a}/${b}</b> τις φορά στα παιχνίδια εκτός έδρας. Πόσες στολές φορά εκτός έδρας;`,
        (n,t,a,b,r) => `Σε μια αγορά πωλούνται ${t} προϊόντα. Τα <b>${a}/${b}</b> είναι ελληνικά. Πόσα προϊόντα είναι ελληνικά;`,
    ],
    ...
    templates3: [
        ...
        (n,r,a,b,t) => ({ text: `${n} ψώνισε και ξόδεψε <b>${r} ευρώ</b> που ήταν τα <b>${a}/${b}</b> των χρημάτων που είχε.`, question: 'Πόσα χρήματα είχε αρχικά;' }),
        (n,r,a,b,t) => ({ text: `Σε ένα λεωφορείο κάθονται <b>${r} επιβάτες</b> που αποτελούν τα <b>${a}/${b}</b> όλων των θέσεων.`, question: 'Πόσες θέσεις έχει το λεωφορείο;' }),
        (n,r,a,b,t) => ({ text: `${n} έτρεξε για <b>${r} λεπτά</b> που ήταν τα <b>${a}/${b}</b> του συνολικού χρόνου προπόνησης.`, question: 'Πόση ώρα διήρκεσε η προπόνηση;' }),
        (n,r,a,b,t) => ({ text: `Σε μια βιβλιοθήκη, <b>${r} βιβλία</b> που αποτελούν τα <b>${a}/${b}</b> της συλλογής, είναι ελληνικά.`, question: 'Πόσα βιβλία έχει η βιβλιοθήκη;' }),
        (n,r,a,b,t) => ({ text: `${n} μάζεψε <b>${r} κιλά</b> αμύγδαλα που ήταν τα <b>${a}/${b}</b> της συνολικής παραγωγής.`, question: 'Πόσα κιλά ήταν η συνολική παραγωγή;' }),
        (n,r,a,b,t) => ({ text: `Σε μια συναυλία, <b>${r} παιδιά</b> που αποτελούν τα <b>${a}/${b}</b> του κοινού, τραγουδούν.`, question: 'Πόσα άτομα υπάρχουν στο κοινό;' }),
        (n,r,a,b,t) => ({ text: `Σε ένα τουρνουά σκάκι, <b>${r} παίκτες</b> που είναι τα <b>${a}/${b}</b> του συνόλου, προκρίθηκαν.`, question: 'Πόσοι παίκτες συμμετείχαν συνολικά;' }),
        (n,r,a,b,t) => ({ text: `${n} αποταμίευσε <b>${r} ευρώ</b> που ήταν τα <b>${a}/${b}</b> του μισθού του/της.`, question: 'Ποιος ήταν ο μισθός;' }),
        (n,r,a,b,t) => ({ text: `Σε ένα σχολείο, <b>${r} μαθητές</b> που αποτελούν τα <b>${a}/${b}</b> του συνόλου, έχουν ποδήλατο.`, question: 'Πόσοι μαθητές υπάρχουν συνολικά;' }),
        (n,r,a,b,t) => ({ text: `${n} διάβασε <b>${r} κεφάλαια</b> που ήταν τα <b>${a}/${b}</b> του βιβλίου.`, question: 'Πόσα κεφάλαια έχει το βιβλίο;' }),
        (n,r,a,b,t) => ({ text: `Σε ένα αεροπλάνο, <b>${r} επιβάτες</b> που αποτελούν τα <b>${a}/${b}</b> των θέσεων, ταξιδεύουν μόνοι.`, question: 'Πόσες θέσεις έχει το αεροπλάνο;' }),
        (n,r,a,b,t) => ({ text: `${n} μοίρασε <b>${r} μολύβια</b> που ήταν τα <b>${a}/${b}</b> από ό,τι είχε.`, question: 'Πόσα μολύβια είχε αρχικά;' }),
        (n,r,a,b,t) => ({ text: `Σε ένα δάσος, <b>${r} δέντρα</b> που αποτελούν τα <b>${a}/${b}</b> όλων, είναι ελιές.`, question: 'Πόσα δέντρα έχει το δάσος;' }),
        (n,r,a,b,t) => ({ text: `${n} έφαγε <b>${r} κομμάτια</b> πίτσας που ήταν τα <b>${a}/${b}</b> της πίτσας.`, question: 'Πόσα κομμάτια είχε η πίτσα;' }),
        (n,r,a,b,t) => ({ text: `Σε μια εκδρομή, <b>${r} μαθητές</b> που αποτελούν τα <b>${a}/${b}</b> της τάξης, έφεραν σακίδιο.`, question: 'Πόσοι μαθητές είναι στην τάξη;' }),
        (n,r,a,b,t) => ({ text: `${n} συμπλήρωσε <b>${r} ασκήσεις</b> που ήταν τα <b>${a}/${b}</b> του φύλλου εργασίας.`, question: 'Πόσες ασκήσεις είχε το φύλλο εργασίας;' }),
        (n,r,a,b,t) => ({ text: `Σε μια αποθήκη, <b>${r} κουτιά</b> που αποτελούν τα <b>${a}/${b}</b> όλων, είναι γεμάτα.`, question: 'Πόσα κουτιά υπάρχουν συνολικά;' }),
        (n,r,a,b,t) => ({ text: `${n} χρησιμοποίησε <b>${r} χρώματα</b> που ήταν τα <b>${a}/${b}</b> της κασετίνας.`, question: 'Πόσα χρώματα έχει η κασετίνα;' }),
        (n,r,a,b,t) => ({ text: `Σε ένα χωριό, <b>${r} σπίτια</b> που αποτελούν τα <b>${a}/${b}</b> όλων, έχουν κήπο.`, question: 'Πόσα σπίτια έχει το χωριό;' }),
        (n,r,a,b,t) => ({ text: `${n} έπαιξε <b>${r} παιχνίδια</b> που ήταν τα <b>${a}/${b}</b> του τουρνουά.`, question: 'Πόσα παιχνίδια είχε το τουρνουά;' }),
    ],
        ...
        if (q.answers.length === 1) {
            ...
            let inputsHTML = q.labels.map((lbl, i) => `
                <div style="display:flex; flex-direction:column; align-items:center; gap:4px;">
                    <span style="font-family:var(--font-alt); font-size:0.78rem; color:var(--wood-dark); font-weight:bold; white-space:nowrap;">${lbl}</span>
